...
{
	if($.cookie('session_id')==null || id==0 || $.cookie('version') == null || $.cookie("version") != version){
		var json = new Object;
		json.q = new Object;
		json.n = 'Session';
		json.q.deviceToken = SESSION_ID;
		json.q.deviceType = '16';
		json.q.version =version;
		json.json = JSON.stringify(json);

		$.post(API_URL,json,function(data){
			if(data.q.s=='0'){
				$.cookie('session_id',data.s,{expires:COOKIE_TIME});
				$.cookie('version',version,{expires:COOKIE_TIME});
				if(id==1){
					Start();
				}
				if(id==0){
		...
		$.cookie('session_id',$.cookie('session_id'),{expires:COOKIE_TIME});
	}
}
