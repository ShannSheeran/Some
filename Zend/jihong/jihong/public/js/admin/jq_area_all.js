...
// 　　　　　　　　return;
// 　　　　　　}
　　　　　　if(opts.cache["provinces"+proIndex] == null){
				cit += "<option value='0'>"+'不限'+"</option>";
...
　　　　　　var cou = "";
　　　　　　if(opts.cache["provinces"+proIndex] == null || opts.cache["provinces"+proIndex].city["cities"+citIndex] == null){
				cou += "<option value='0'>"+'不限'+"</option>";
