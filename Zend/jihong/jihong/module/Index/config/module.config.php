...
return array(
    'controllers' => array(
        'invokables' => array(
            ...
            'Index\Controller\Login'=>  'Index\Controller\LoginController',
            'Index\Controller\User' => 'Index\Controller\UserController',
            'Index\Controller\Goods'=>  'Index\Controller\GoodsController',
            'Index\Controller\Service'=>  'Index\Controller\ServiceController',
            'Index\Controller\Order'=>  'Index\Controller\OrderController',
        )
    ),
...
//                     'route'    => '/[:controller][/][:action][[/:id][/a:alert][/s:search][/p:page][/l:language]]',
                    'route'    => MODULE_INDEX . '[[:controller][/:action][/:id][/bc:bc][/sc:sc][/sort:sort][/c:cid][/a:alert][/b:between][/:cardid][/t:type][/p:page][/st:status][/s:search].html]',
					'constraints'=>array(
