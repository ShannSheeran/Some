...
/** 请选择其它支付方式 @var 1116 */
define('Alipay_Error' , '1116' );
define('DESCRIPTION_1116' , '请选择其它支付方式');
define('REAL_DESCRIPTION_1116' , '请选择其它支付方式！');
/** 请选择其它支付方式 @var 1118 */
define('Alipay_type_Error' , '1118' );
define('DESCRIPTION_1118' , '支付方式与下单选择方式不相符！');
define('REAL_DESCRIPTION_1118' , '支付方式与下单选择方式不相符！');
/** 名片识别失败 @var 1117 */
define('CARD_RECOGNITION_FALSE' , '1117' );
define('DESCRIPTION_1117' , '名片识别失败');
define('REAL_DESCRIPTION_1117' , '名片识别失败！');


/** 库存不足@var 1022 */
define('STATUS_UNDER_STOVK' , '1022' );
define('DESCRIPTION_1022' , '库存不足');
define('REAL_DESCRIPTION_1022' , '库存不足');


/** 商品已下架@var 1033 */
define('STATUS_IS_TOP' , '1033' );
define('DESCRIPTION_1033' , '商品已下架');
define('REAL_DESCRIPTION_1033' , '商品已下架');
...
/** 参数不符合条件 @var 9010 */
define('STATUS_PARAMETERS_CONDITIONAL_ERROR' , '9010' );
define('DESCRIPTION_9010' , '参数不符合条件');
define('REAL_DESCRIPTION_9010' , '参数不符合条件');
/** 订单部分商品已申请售后 @var 9011 */
define('STATUS_ORDER_SERVICE_ERROR' , '9011' );
define('DESCRIPTION_9011' , '订单部分商品已申请售后');
define('REAL_DESCRIPTION_9011' , '订单部分商品已申请售后');
/*
 * 协议返回用 end
 */
/*
...
define('SMS_LIMIT_IP', 0);
/** 同一个手机号码，24小时内可以获取验证码的数量（0表示不限制） */
define('SMS_LIMIT_MOBILE', 0);
/** 同一个手机号码，1小时内可以获取验证码的数量（0表示不限制） */
// define('SMS_LIMIT_TIME_MOBILE', 3);
/** 同一个SessionId可以获取验证码的数量（0表示不限制） */
define('SMS_LIMIT_SESSION_ID', 0);
