...
define('WXPAY_HTTP', "http://" . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : "") . HTTP_EXTRA . "/wxpay/action/");
define('INDEX_HTTP', "http://" . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : "") . HTTP_EXTRA );
