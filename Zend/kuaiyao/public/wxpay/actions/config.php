<?php 
define('PROJECT_MODE' , 1); // 1内网，2外网；
define('HTTP_EXTRA', PROJECT_MODE == 1 ? "/kuaiyao/public" : "");
define('WXPAY_HTTP', "http://" . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : "") . HTTP_EXTRA . "/wxpay/actions/");
define('INDEX_HTTP', "http://" . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : "") . HTTP_EXTRA );//127.0.0.1/kuaiyao/public
define('INDEX_HTTPs',"http://" . $_SERVER['SERVER_NAME']);
