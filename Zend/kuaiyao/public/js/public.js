...
//myModal1 myModal2
$('.btn-setting1').click(function(e){
	e.preventDefault();
	$('#myModal1').modal('show');
});
$('.btn-setting2').click(function(e){
	e.preventDefault();
	$('#myModal2').modal('show');
});

$('.btn-setting3').click(function(e){
	e.preventDefault();
	$('#myModal3').modal('show');
});

$('.btn-setting4').click(function(e){
	e.preventDefault();
	$('#myModal4').modal('show');
});

$('.btn-setting5').click(function(e){
	e.preventDefault();
	$('#myModal5').modal('show');
});
});*/
