...
use Api3\Model\PublicTable;
use Api3\Controller\Common\Login;
use Api3\Controller\Common\Structure;
use Api3\Controller\Common\Request;
use Api3\Controller\Common\TableRequest;
use Api3\Controller\Common\WhereRequest;
use Api3\Controller\Common\Response;
...
use Api3\Controller\Item\PushFromItem;
use Api3\Controller\Item\PushArgsItem;
use Api3\Controller\Item\PushTemplateItem;
use Core\System\AiiUtility\AiiWxPayV3\AiiWxPay;
use Core\System\AiiUtility\AiiEmail\AiiEmail;
use Core\System\YlPay\YlPay;
...
//                 @file_put_contents($filename, $data);
    ...
    {
        if (! isset($this->index_controller))
        {
...
//                 $result = $this->pushForDeviceCollection();
     ...
     */
    public function getWxPayInfo($id, $amount)
    {
     ...
     */
    public function getYlPayInfo($id, $amount,$type)
    {
