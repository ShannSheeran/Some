            ...
            if ($data['list']) {
                ...
                foreach ($data['list'] as $val) {
                    ...
                    $company_info = array(
                        ...
                        'name' => $company ? $company['name'] : $val['company'],
                    );
                    $path = $this->getImagePath($cardname['wx_code']);
...
//                 echo '</pre>';
                ...
                if ($data) {
                    ...
                    foreach ($data['list'] as $val) {
                        $cardname = $this->getCarteTable()->getOne(array('id'=>$val['carte_id']));
        ...
        if (isset($action) && $action == 5) {
            ...
            foreach ($data['list'] as $val) {
                $is_buy = $this->getUserTable()->getOne(array('id'=>$val['id']));         
                $job = $this->getCarteTable()->getOne(array('id'=>$val['carte_id']));
