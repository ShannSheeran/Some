...
// 签名证书路径
define("SDK_SIGN_CERT_PATH", __DIR__ . '/../../' . 'kuaiyao_unionpay_wuzhao_password_000000.pfx');
// const SDK_SIGN_CERT_PATH = 'D:/xampp/htdocs/upacp_sdk_php/PM_700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
 define("SDK_ENCRYPT_CERT_PATH", __DIR__ . '/../../' . 'RSA2048_PROD_index_22.cer');
// const SDK_ENCRYPT_CERT_PATH = 'D:/xampp/htdocs/upacp_sdk_php/verify_sign_acp.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
define("SDK_VERIFY_CERT_DIR", __DIR__ . '/../..');
// const SDK_VERIFY_CERT_DIR = 'D:/xampp/htdocs/upacp_sdk_php';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://192.168.1.10/upacp_sdk_php/demo/utf8/FrontReceive.php';
// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL = 'http://2009.aiitec.net:88/kuaiyao/public/api/v5/api/index/getYlpayNotify';
