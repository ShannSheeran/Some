(function VideoController($angular) {
    ...
    function videoController($scope, $timeout, video) {
         ...
         */
        $scope.videos = {
            first:  'http://www.me.com/angular/ngVideo/media/Skyfall.mp4',
            second:  'http://www.me.com/angular/ngVideo/media/HD.mp4',
            third:  'http://www.me.com/angular/ngVideo/media/HD.mp4',
        };
