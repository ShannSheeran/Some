...
angular.module('app')
    ...
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '</ul>' +
            '<div class="pagination m-page" ng-show="conf.totalItems > 0">' +
            '<input type="text"  class="form-control m-page-input" ng-model="jumpPageNum" ng-keyup="jumpPageKeyUp($event)"/>' +
            '<button class="btn m-page-img" ng-click="jumpToPage()" ng-disabled="!jumpPageNum">' +
            '<img src="img/enter.png" alt="" />' +
            '</button>'+
            '</div>' +
            '<div class="m-page-total" ng-show="conf.totalItems > 0">' +
            ...
            '共&nbsp;{{ conf.totalItems }}&nbsp;条信息&nbsp;&nbsp;&nbsp;' +
            '第{{conf.currentPage}}页/共{{conf.numberOfPages }}页' +
        ...
        link: function(scope, element, attrs) {
            ...
            scope.prevPage = function() {
                if(conf.currentPage > 1){
                    conf.currentPage -= 1;
                    scope.changeCurrentPage(conf.currentPage);
                }
            };
