...
<head>
 <meta charset="UTF-8">
<title>ShowDoc</title>
 <link rel="stylesheet" href="/apidoc/Public/bootstrap/css/bootstrap.min.css">

 <link rel="stylesheet" href="/apidoc/Public/css/jquery.fullPage.css">
 <style>
...
<div id="dowebok">
    <div class="section">
        <img src="/apidoc/Public/logo/b_64.png" alt="">
...
<script src="/apidoc/Public/js/jquery.fullPage.min.js"></script>
<script>
$(function(){
    $('#dowebok').fullpage({
