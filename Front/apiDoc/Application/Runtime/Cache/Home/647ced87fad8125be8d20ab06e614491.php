...
<link rel="stylesheet" href="/apidoc/Public/css/page/edit.css?1.1thirdef" />
...
<!--         <button id="jsons" tabindex="8" style="margin-left: 100px;"><?php echo (L("json_to_table")); ?></button> -->
        ...
        <a href="http://runapi.showdoc.cc/" target="_blank" class="btn" tabindex="9" id="runapi"><?php echo (L("http_test_api")); ?></a>
    </div>
    <div id="editormd">
...
<script src="/apidoc/Public/js/page/edit.js?v=1.1.2thirdonmopqrstutv"></script>
<?php if(LANG_SET=='en-us'): ?><script src="/apidoc/Public/editor.md/languages/en.js"></script><?php endif; ?>