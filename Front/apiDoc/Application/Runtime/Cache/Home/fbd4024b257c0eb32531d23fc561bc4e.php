...
<html lang="en">
  ...
  <body>
<link rel="stylesheet" href="/apidoc/Public/css/item/index.css?v=1.2" />
...
<!--           <li><a href="#share-home-modal"  data-toggle="modal"><?php echo (L("share_home")); ?></a></li>
 -->          <li><a href="https://github.com/star7th/showdoc/issues" target="_blank"><?php echo (L("feedback")); ?></a></li>
        ...
        <h3 class="muted"><img src="/apidoc/Public/logo/b_64.png" style="width:50px;height:50px;margin-bottom:15px;" alt="">ApiDoc</h3>
      </div>
